...
- **Binding windows**: Visual binding timescales (30-50 ms) are recovered from independently constrained parameters
...
Todd, I. (2026). *BioSystems* (accepted for publication, BIOSYS-D-25-00981).
