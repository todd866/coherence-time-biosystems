...
\textbf{All-to-all coupling} ($\hat{\alpha} \approx 1$ via linearized surrogate, $n=8$): theory-consistent fit is ill-conditioned in this high-coherence regime where $\bar{r}_{\mathrm{inter}} \approx 1$ makes $-\log p_1 \approx 0$; the surrogate value slightly exceeding 1 reflects linearization error.
