...
\item \textbf{Sparse networks:} Network fragments; modules do not behave as semi-independent phase explorers. The first-passage alignment event the theory models does not occur cleanly.
\end{itemize}
